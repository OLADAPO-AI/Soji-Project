  ...
  return (
    <section className="min-h-screen bg-white/90 rounded-t-3xl py-20 lg:px-20 px-6 sm:px-10">
      <div className="flex flex-col divide-y-[1px] divide-gray-300 w-full">
        {/* Section Header */}
        <div className="pb-8">
          <div className="flex text-red-400 items-center flex-row gap-4 text-[12px] lg:text-sm font-semibold">
            <FaDotCircle />
        ...
        {insightData.map((data, i) => (
          <div
            key={i}
            className="grid lg:gap-20 sm:gap-10 gap-2 py-8 grid-cols-1 sm:grid-cols-5"
          >
            {/* Image Section */}
