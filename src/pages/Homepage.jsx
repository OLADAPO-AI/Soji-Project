  ...
  return (
    <div className="h-fit w-screen">
      <div className="bg-hero-bg  bg-cover bg-no-repeat bg-center min-h-screen w-screen">
        <div className="h-screen bg-black/20 flex items-center relative text-white">
          <div className="lg:ml-4 px-4 pb-4 bg-black/10 backdrop-blur-sm xl:justify-center md:w-[50%] sm:w-[60%] xl:w-[40%] w-full mx-auto lg:mx-0 lg:h-[50%] h-[40%]  pt-4 absolute font-bold flex flex-col bottom-10">
