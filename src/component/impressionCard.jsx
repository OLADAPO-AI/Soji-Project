...
function ImpressionCard() {
  return (
    <div className="w-full md:w-4/5 gap-6 p-6 sm:p-8 h-auto bg-white/20 backdrop-blur-lg mb-6 rounded-2xl shadow-2xl overflow-hidden border border-white/10 flex flex-col justify-center items-center border-accent-dark mx-auto">
      {/* Image Grid */}
      ...
      {/* Button */}
      <div className="flex justify-center gap-4 flex-col sm:flex-row mt-6">
        <Link to={'/getintouch'}>
