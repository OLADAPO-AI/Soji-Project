  ...
  return (
    <div className="bg-hero-bg bg-cover bg-no-repeat bg-center min-h-screen w-screen">
      <div className="h-screen bg-black/30 flex items-center relative text-text">
        <div className="lg:ml-4 px-4 py-4 bg-neutral-600/30 lg:w-[50%] md:w-[50%] w-full mx-auto lg:mx-0 lg:h-[50%] h-[50%] justify-center absolute font-bold flex flex-col bottom-10">
